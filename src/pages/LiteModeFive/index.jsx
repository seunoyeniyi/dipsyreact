          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-[98%] md:w-full">
              <div className="bg-gray-100 flex flex-col items-center justify-start mb-14 p-8 sm:px-5 w-[77%] md:w-full">
                <div className="bg-white-A700 flex flex-col items-center justify-start mb-[465px] outline outline-[1px] outline-blue_gray-100 p-4 rounded-[12px] w-full">
                  <div className="flex flex-col gap-[15px] items-center justify-start mb-[100px] mt-20 w-full">
                    <div className="flex sm:flex-col flex-row gap-[23px] items-center justify-between max-w-[843px] w-full">
                      <Text
                      ...
                      <Text
                        ...
                        size="txtPoppinsMedium16Black900"
                      >
                        Order Date: January 6 | 6:am
                      </Text>
                      <Button
                        className="bg-black-900 cursor-pointer flex items-center justify-center min-w-[153px] px-3 py-1.5 rounded-lg"
                        rightIcon={
                          <Img
                            className="h-7 ml-2"
                    ...
                    <div className="flex sm:flex-col flex-row gap-[54px] items-center justify-start max-w-[843px] outline outline-blue_gray-100 px-4 py-2 w-full">
                      <Text
                    ...
                    <div className="flex md:flex-col flex-row gap-14 items-center justify-center outline outline-blue_gray-100 px-4 py-2 rounded-lg w-auto md:w-full">
                      <Text
                      ...
                      <div className="flex flex-row gap-1 items-center justify-start w-[72px]">
...
export default LiteModeFivePage;
